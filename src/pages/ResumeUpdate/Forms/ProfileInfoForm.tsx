...
interface IProps {
	...
	updateSection: (key: string, value: string | File | null) => void
	onNext: () => void
}
const ProfileInfoForm = ({ profileData, updateSection }: IProps) => {
	return (
		<div className='px-5 pt-5'>
			...
			<div className='mt-4'>
				<ProfilePhotoSelector
					...
					setImage={value => updateSection('profileImg', value as File)}
