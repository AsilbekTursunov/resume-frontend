...
const TemplateThree = ({ resumeData, colorPalette, containerWidth }: IProps) => {
				...
				>
					{resumeData.profileInfo.profilePreviewUrl ? (
						<img
							...
							className='w-[90px] h-[90px] rounded-2xl object-cover object-top'
						/>
					) : (
						<div
							...
							<div className='flex items-center flex-wrap gap-3 mt-4'>
								{resumeData.interests.map((interest, index) => {
									...
									return (
										<div
											key={`interest_${index}`}
											className='text-[10px] font-medium py-1 p-3 rounded-lg'
										>
											{interest}
										</div>
									)
